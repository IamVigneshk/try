...
import { Server, Shield, Database, Cloud, Wifi } from 'lucide-react';
...
export default function ScanningInterface({ targetInfo, isAdmin }: ScanningInterfaceProps) {
  ...
  useEffect(() => {
    ...
    const interval = setInterval(() => {
      setScanProgress((prev) => {
        ...
        return prev + (100 / totalDuration) * 50; // Adjust speed here
      });
    }, 50);
